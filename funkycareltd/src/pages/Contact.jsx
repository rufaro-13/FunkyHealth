...
{/* <Helmet>
        ...
        <section className=" bg-cover bg-center bg-no-repeat  bg-darkblue  bg-blend-multiply">
            <div className="px-4 mx-auto max-w-7xl justify-items-center bg- py-24 lg:py-50">
                <h1 className="mb-1 pt-10 text-4xl font-extrabold  tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                 Contacting Us </h1>
        ...
        <section className='px-4 mx-auto  text-center pt-6 md:pt-4 py-4 lg:py-24'>
            <div className=" max-w-screen-xl mt-5 pt-4">
               ...
               {/*  <div className="lg:px-4 mx-auto max-w-screen-xl text-center pt-6 mt-6 ">
                  ...
                  <div className='lg:w-full '> 
                   <div className=" px-2 md:px-8 pt-4 items-center sm:items-center sm:justify-center mx-4  lg:mx-4 mt-1">
                     ...
                     <div className="lg:px-5 px-4   max-w-max   sm:items-center sm:justify-center"> 
                        ...
                        <IconContext.Provider value={{ color: '#057a8a', size: '40px', padding:'5px 2px' }}>
                    ...
                    <div className="lg:px-5 px-2   max-w-max   sm:items-start sm:justify-start">
                          ...
                          <div className="  sm:items-center sm:justify-center   mt-1">
                            ...
                            className="block py-2  underline text-darkblue rounded hover:bg-gray-100 md:hover:bg-transparent 
                            md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-darkblue dark:hover:bg-gray-700
                              ...
                              <div>
                                <span className="text-black text-2xl font-bold">
                                  <a href="https://www.google.com/maps/place/12+Hall+Dr,+Sandiacre,+Nottingham+NG10+5BT,+UK/@52.9240473,-1.2915212,17z" 
                                      className="block py-2  underline text-darkblue rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-darkblue dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Visit Us</a></span></div>
                ...
                <div className="md:pt-5 justify-items-center lg:w-3/5 sm:w-full">
                    <h1 className='font-bold md:text-2xl text-xl text-darkblue'>Enquiry Form</h1>
                  <div className="lg:px-0 px-1 pb-4  pt-5 mt-1 w-full md:w-full sm:items-start sm:justify-start">
                  <form className="  w-full" ref={form} onSubmit={sendEmail}>
                
                    <div className="mb-6 text-left">
                      <label
                        htmlFor="name"
                        className="block mb-2 text-gray-900 text-sm dark:text-black"
                      >
