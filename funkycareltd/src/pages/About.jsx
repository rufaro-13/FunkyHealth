...
export default function About() {
  return (
        <div className="pt-8 mt-8 min-h-screen ">
            ...
            <div  className=" items-center md:grid md:grid-cols-2 bg-neutral-primary-soft px-6 pt-1  rounded-base md:flex-row  md:flex-row ">
                <div  className="md:flex md:flex-col items-center bg-neutral-primary-soft p-2  rounded-base  ">
                ...
                <div  className="md:flex md:flex-col items-center  p-2  rounded-base  ">
